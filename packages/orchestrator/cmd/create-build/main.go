...
func doBuild(
	...
	sandboxFactory := sandbox.NewFactory(c.BuilderConfig, networkPool, devicePool, nil, featureFlags, hoststats.NewNoopDelivery(), cgroup.NewNoopManager(), network.NewNoopEgressProxy(), sandboxes)
