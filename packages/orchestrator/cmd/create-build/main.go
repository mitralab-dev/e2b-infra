...
func doBuild(
	...
	sandboxFactory := sandbox.NewFactory(ctx, c.BuilderConfig, networkPool, devicePool, nil, featureFlags, hoststats.NewNoopDelivery(), cgroup.NewNoopManager(), network.NewNoopEgressProxy(), sandbox.NoopNetworkAssignHook{}, sandboxes)
